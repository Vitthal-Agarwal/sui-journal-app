...
export function CreateJournal({
  ...
  function create() {
    ...
    // Task 2: Call journal::new_journal with the user-provided title
    const newJournal = tx.moveCall({
      target: `${journalPackageId}::journal::new_journal`,
      arguments: [tx.pure.string(title)],
    });

    // Task 3: Transfer the returned Journal object to the connected user
    tx.transferObjects([newJournal], currentAccount.address);
